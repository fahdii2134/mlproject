...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        '''
        this function is responsible for datatransformtion'''
        try:
            ...
            preprocessor = ColumnTransformer(
                [
                    ('num_columns',num_pipeline,numerical_columns),
    ...
    def intitiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info(
                f"applying preprocessing object on trainiing dataframe and testing dataframe."
            )
